  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `note` (`id` TEXT NOT NULL, `texter` TEXT NOT NULL, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"93e3afd3cd40393badc4de52c124f826\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsNote.put("id", new TableInfo.Column("id", "TEXT", true, 1));
        _columnsNote.put("texter", new TableInfo.Column("texter", "TEXT", true, 0));
        ...
        if (! _infoNote.equals(_existingNote)) {
          throw new IllegalStateException("Migration didn't properly handle note(com.example.roomcomponents.Note).\n"
                  + " Expected:\n" + _infoNote + "\n"
                  + " Found:\n" + _existingNote);
        }
      }
    }, "93e3afd3cd40393badc4de52c124f826", "71d2845efc68c5a7f727d3bf694a7524");
